...
9. `/dt Healer HealType 0|1|2|3` Changes the heal type to following:
    1. /if (${int_healMode}==0) /cecho \a-wChanging healing \aoTYPE \a-wto \ag0-Self (only)
    2. /if (${int_healMode}==1) /cecho \a-wChanging healing \aoTYPE \a-wto \ag1-MT (and self)
    3. /if (${int_healMode}==2) /cecho \a-wChanging healing \aoTYPE \a-wto \ag2-Group (and MT, includes self)
    4. /if (${int_healMode}==3) /cecho \a-wChanging healing \aoTYPE \a-wto \ag3-GroupOnly (includes self)
